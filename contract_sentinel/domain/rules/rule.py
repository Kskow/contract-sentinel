...
class RuleName(StrEnum):
    ...
    METADATA_FORBIDDEN_VALUES_MISMATCH = "METADATA_FORBIDDEN_VALUES_MISMATCH"
    METADATA_CONTAINS_ONLY_MISMATCH = "METADATA_CONTAINS_ONLY_MISMATCH"
    METADATA_CONTAINS_NONE_OF_MISMATCH = "METADATA_CONTAINS_NONE_OF_MISMATCH"
